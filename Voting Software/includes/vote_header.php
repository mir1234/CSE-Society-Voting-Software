...
<div id="wrap">
  <div id="header">
	...
	<div id="nav" style="background: url(images/1.jpg);">
		<a href="vote.php"><img src="images/logo.png" height="140" width="120" alt="Logo"></a>
		<a href="vote.php" style="text-decoration: none;color:white;"><h1 style="margin-bottom:20px;" onMouseOver="this.style.color='yellow'" onMouseOut="this.style.color='white'"> CSE Society Election - <?php echo date("y"); ?> </h1></a>
	</div>
	 <!--end nav-->
  </div>
  <!--end header-->
